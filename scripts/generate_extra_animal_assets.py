...
def make_leopard_cat() -> dict[str, object]:
    img, d = canvas(84, 48)
    shadow(d, 10, 40, 58, 5)
    line(d, [(18, 24), (8, 21), (2, 17)], "#3b2118", 6)
    line(d, [(18, 24), (8, 21), (2, 17)], "#9a7650", 4)
    for x, y in [(4, 18), (9, 20), (14, 22)]:
        px(d, x, y, 4, 2, "#2a1711")
    ellipse(d, 18, 18, 44, 17, "#c08a55", INK_SOFT)
    ellipse(d, 23, 25, 35, 8, "#ead0a6", INK_SOFT)
    ellipse(d, 56, 13, 18, 16, "#c8905a", INK_SOFT)
    poly(d, [(58, 14), (58, 6), (65, 11)], "#c8905a", INK_SOFT)
    poly(d, [(69, 14), (74, 7), (76, 16)], "#c8905a", INK_SOFT)
    ellipse(d, 66, 20, 12, 8, "#f0d7b4", INK_SOFT)
    px(d, 77, 22, 4, 2, "#23150e")
    px(d, 68, 18, 3, 3, "#111111")
    px(d, 69, 19, 1, 1, "#fff7d7")
    line(d, [(64, 15), (66, 24)], "#4f2d1d", 1)
    line(d, [(72, 16), (70, 24)], "#4f2d1d", 1)
    px(d, 61, 24, 3, 2, "#3a2115")
    px(d, 70, 26, 7, 1, "#f4eed8", 150)
    for x, y, w, h in [
        (24, 20, 5, 3), (33, 19, 6, 3), (43, 20, 5, 3), (52, 21, 4, 3),
        (27, 25, 4, 2), (36, 26, 5, 2), (47, 26, 4, 2), (58, 18, 4, 2),
        (31, 30, 3, 2), (42, 31, 4, 2), (53, 30, 3, 2),
    ]:
        px(d, x, y, w, h, "#3a2115")
    for x, y in [(22, 23), (39, 23), (49, 24), (61, 17)]:
        px(d, x, y, 2, 2, "#ead0a6", 150)
    line(d, [(25, 31), (21, 40)], "#80583a", 4)
    line(d, [(38, 31), (34, 40)], "#80583a", 4)
    line(d, [(55, 30), (54, 40)], "#80583a", 4)
    line(d, [(67, 28), (66, 39)], "#80583a", 4)
    for x, y in [(18, 40), (31, 40), (51, 40), (63, 39)]:
        px(d, x, y, 9, 3, "#241812")
    for x, y in [(23, 33), (35, 34), (54, 33), (66, 31)]:
        px(d, x, y, 3, 2, "#3a2115")
